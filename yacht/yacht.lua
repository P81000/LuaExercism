...
yacht.score = function(dice, category)
    ...
    if category == "choice" then return dice[1] + dice[2] + dice[3] + dice[4] + dice[5] end
    ...
    if category == "full house" then return (count == 2 and seen[index[1]] == 3 or seen[index[2]] == 3) and index[1] * seen[index[1]] + index[2] * seen[index[2]] or 0 end
